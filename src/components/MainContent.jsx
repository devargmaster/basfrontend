        ...
        if (!user?.rol?.esAdministrador) {
          return (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Acceso Restringido</h3>
              <p className="text-gray-600">Solo los administradores pueden acceder a los logs del sistema.</p>
              <p className="text-sm text-gray-500 mt-2">
                Esta funcionalidad está reservada para usuarios con permisos de administrador.
              </p>
            </div>
          );
        }
